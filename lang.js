...
window.KKN_LANG = {
    ...
    id: {
        ...
        p2_title:       "UMKM & Ekonomi Lokal",
        p2_desc:        "Mendorong kemandirian ekonomi desa dengan melakukan digitalisasi pemasaran, rebranding kemasan, dan sosialisasi manajemen keuangan.",
        p3_title:       "Kesehatan & Sanitasi",
        p3_desc:        "Meningkatkan kesadaran pola hidup bersih dan sehat (PHBS) warga desa serta melakukan sosialisasi intensif pencegahan stunting.",
        ...
        profil_potensi_h:   "Potensi & Karakteristik Dusun",
        profil_potensi_p:   "Dusun Wungurejo memiliki kekayaan filosofis dari kata \"Wungu\" (bunga yang tumbuh subur di tepi sungai) dan \"Rejo\" (makmur). Sebagai bagian dari rintisan Desa Wisata Wandari Mukti, dusun ini menyimpan potensi luar biasa di bidang kesenian tradisional (seperti Reog dan Gejog Lesung), peternakan madu klanceng, serta bentang alam perbukitan yang asri. KKN 84.095 hadir untuk berkolaborasi mengoptimalkan potensi tersebut menuju kemandirian ekonomi dan pelestarian budaya.",
        visi_title:         "Visi Kami",
        visi_desc:          "Menjadi jembatan inovasi ilmiah akademis dengan kearifan lokal guna meningkatkan daya saing masyarakat Dusun Wungurejo.",
        ...
        demo_rt:            "Rukun Tetangga (RT)",
        demo_gender:        "Rasio Gender",
        demo_lakilaki:      "Laki-laki",
        ...
        gb_label_role:      "Status / Peran",
        gb_opt_warga:       "Warga Dusun Wungurejo",
        gb_opt_perangkat:   "Perangkat Desa",
        gb_opt_mhs:         "Mahasiswa KKN",
        gb_opt_dosen:       "Dosen Pembimbing Lapangan",
        gb_opt_umum:        "Pengunjung Umum",
        gb_label_msg:       "Pesan Anda",
        gb_ph_msg:          "Tuliskan pesan atau saran Anda di sini...",
        ...
        map_loc_1_name: "Balai Padukuhan Wungurejo",
        map_loc_1_desc: "Pusat administrasi dusun dan lokasi berbagai sosialisasi proker.",
        map_loc_1_type: "Fasilitas Umum",
        map_loc_2_name: "Masjid Al Amin",
        map_loc_2_desc: "Pusat kegiatan ibadah kemasyarakatan dan pendidikan keagamaan warga.",
        map_loc_2_type: "Fasilitas Ibadah",
        map_loc_3_name: "Pengrajin Popor",
        map_loc_3_desc: "Usaha kerajinan popor kayu, potensi UMKM unggulan Dusun Wungurejo.",
        map_loc_3_type: "UMKM Lokal",
        map_loc_4_name: "Toko Qutis",
        map_loc_4_desc: "Salah satu warung kelontong penggerak ekonomi mikro warga.",
        map_loc_4_type: "UMKM Lokal",
        map_loc_5_name: "Makam Punthuk",
        map_loc_5_desc: "Situs pemakaman bersejarah yang menjadi bagian dari warisan budaya Dusun Wungurejo.",
        map_loc_5_type: "Situs Budaya",
        map_loc_6_name: "Peternak Ikan Sugino Wiryo",
        map_loc_6_desc: "Usaha budidaya perikanan lokal, potensi UMKM peternakan ikan di Dusun Wungurejo.",
        map_loc_6_type: "UMKM Lokal",
        map_loc_7_name: "TPQ Tarbiyatul Muchcinin",
        map_loc_7_desc: "Pusat pendidikan agama dan taman bacaan Al-Quran bagi anak-anak dusun.",
        map_loc_7_type: "Pendidikan & Agama",
        map_loc_8_name: "Masjid Darussalam",
    ...
    en: {
        ...
        hero_desc:      "Official website of the Community Service Program (KKN) Group AA 84.095, UPN \"Veteran\" Yogyakarta. Together with the community, we build independence, education, and village welfare.",
        ...
        p2_title:       "SMEs & Local Economy",
        p2_desc:        "Driving village economic independence through marketing digitization, packaging rebranding, and financial management outreach.",
        p3_title:       "Health & Sanitation",
        p3_desc:        "Raising awareness of clean and healthy living (PHBS) among villagers and conducting intensive stunting prevention outreach.",
        ...
        profil_potensi_h:   "Village Potential & Characteristics",
        profil_potensi_p:   "Wungurejo Hamlet carries philosophical richness from the words \"Wungu\" (a flower that blooms along riverbanks) and \"Rejo\" (prosperity). As part of the pioneering Wandari Mukti Tourism Village, it holds remarkable potential in traditional arts (such as Reog and Gejog Lesung), klanceng honey farming, and a beautiful hilly landscape. KKN 84.095 is here to collaborate in optimizing this potential toward economic independence and cultural preservation.",
        visi_title:         "Our Vision",
        visi_desc:          "To become a bridge of academic scientific innovation and local wisdom to enhance the competitiveness of the Wungurejo Hamlet community.",
        ...
        demo_kk:            "Households",
        demo_rt:            "Neighborhood Units (RT)",
        demo_gender:        "Gender Ratio",
        demo_lakilaki:      "Male",
        ...
        gb_form_title:      "Send a New Message",
        gb_label_name:      "Full Name",
        gb_ph_name:         "E.g.: Mr. Budi",
        gb_label_role:      "Status / Role",
        gb_opt_warga:       "Wungurejo Village Resident",
        gb_opt_perangkat:   "Village Official",
        gb_opt_mhs:         "KKN Student",
        gb_opt_dosen:       "Field Supervisor Lecturer",
        gb_opt_umum:        "General Visitor",
        gb_label_msg:       "Your Message",
        gb_ph_msg:          "Write your message or suggestions here...",
        ...
        map_loc_1_name: "Wungurejo Hamlet Hall",
        map_loc_1_desc: "Hamlet administration center and location for various program socializations.",
        map_loc_1_type: "Public Facility",
        map_loc_2_name: "Al Amin Mosque",
        map_loc_2_desc: "Center for community worship and religious education.",
        map_loc_2_type: "Worship Facility",
        map_loc_3_name: "Rifle Stock Craftsman",
        map_loc_3_desc: "Wooden rifle stock craft business, a leading SME potential in Wungurejo.",
        map_loc_3_type: "Local SME",
        map_loc_4_name: "Qutis Grocery Store",
        map_loc_4_desc: "One of the grocery stores driving the micro-economy of residents.",
        map_loc_4_type: "Local SME",
        map_loc_5_name: "Punthuk Cemetery",
        map_loc_5_desc: "A historic burial site that is part of Wungurejo's cultural heritage.",
        map_loc_5_type: "Cultural Site",
        map_loc_6_name: "Sugino Wiryo Fish Farm",
        map_loc_6_desc: "Local aquaculture business, potential fish farming SME in Wungurejo.",
        map_loc_6_type: "Local SME",
        map_loc_7_name: "Tarbiyatul Muchcinin Quranic School",
        map_loc_7_desc: "Center for religious education and Quran reading garden for hamlet children.",
        map_loc_7_type: "Education & Religion",
        map_loc_8_name: "Darussalam Mosque",
