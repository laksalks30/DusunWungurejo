document.addEventListener('DOMContentLoaded', () => {
    ...
    const prokersData = [
        // PROKER BERSAMA
        { id: 1, type: "Proker Bersama", owner_name: null, title: "Pembuatan Peta Administrasi Fisik dan Digital", description_markdown: "Program kerja ini difokuskan pada pemetaan tata ruang Dusun Wungurejo guna menghasilkan peta administrasi yang representatif dan akurat, baik dalam wujud fisik maupun digital. Peta ini memuat informasi spasial yang komprehensif, mencakup delineasi batas wilayah Rukun Tetangga (RT), sebaran lokasi fasilitas umum, hingga pemetaan keruangan dari potensi UMKM yang ada. Inisiatif ini diharapkan dapat menjadi instrumen strategis untuk mendukung perencanaan pembangunan dusun sekaligus mempermudah aksesibilitas informasi geografis bagi masyarakat dan pihak-pihak terkait.", status: "Selesai", image_urls: ["assets/ProgramKerja/Pembuatan Peta Administrasi Fisik dan Digital/Untitled-2.jpg.jpeg", "assets/ProgramKerja/Pembuatan Peta Administrasi Fisik dan Digital/IMG_3389.jpg", "assets/ProgramKerja/Pembuatan Peta Administrasi Fisik dan Digital/e75bdf98-59fa-48e5-bf5f-a4a9eb101111.jpg"] },
    ...
    const openDetailsModal = (item, itemType) => {
        ...
        if (item.pdf_url) {
            ...
            pdfBtn.innerHTML = '<i class="fa-solid fa-file-pdf"></i> Lihat / Unduh Dokumen (PDF)';
