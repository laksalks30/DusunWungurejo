document.addEventListener('DOMContentLoaded', () => {
    ...
    const prokersData = [
        ...
        { id: 8, type: "Proker Individu", owner_name: "Laksana Atmaja Putra", title: "Pembangunan Website Dusun", description_markdown: "Pengembangan website profil Dusun Wungurejo sebagai pusat informasi digital. Website ini mencakup profil dusun, WebGIS interaktif, katalog promosi UMKM, serta digitalisasi rekam jejak program kerja dan logbook KKN.", status: "Selesai", image_urls: ["assets/ProgramKerja/Laksa/IMG_3396.HEIC"] },
